...
@section('content')
    ...
    <div id="table-url" data-url="{{route('purchase_history')}}"></div>
                        ...
                        <div class="table-responsive">
                            <table id="serviceList" class="user-dashboard-table table table-striped table-bordered data-table display responsive">
                                ...
                                <tr>
                                    ...
                                    <th class="all">{{__('Price (in USD)')}}</th>
...
@endsection
@section('script')
    <script src="{{asset('assets/user/js/datatables/purchase-history.js')}}"></script>
